...
public class FrmPrincipal extends JFrame {
    ...
    public FrmPrincipal(ArrayList<Punto> listaPuntos,LinkedHashMap<String, Capa> mapaCapasKML,ArrayList<Punto> listaLugares) {
    ...
    public void abrirItemMenu(ItemsMenuPpal itemMenuPpal) {
        ...
        switch (itemMenuPpal) {
            case MOSTRAR_KDE:
                FrmMostrarKDE frmMostrarKDE = new FrmMostrarKDE(this,this.listaPuntos,this.mapaCapasKML, this.listaLugares);
